...
static const struct pll_rate_table g12a_pll_rate_table[] = {
	...
	PLL_RATE(1872000000, 156, 1, 1), /*DCO=3744M*/
	PLL_RATE(1896000000, 158, 1, 1), /*DCO=3792M*/
	PLL_RATE(1908000000, 159, 1, 1), /*DCO=3816M*/
	PLL_RATE(1920000000, 160, 1, 1), /*DCO=3840M*/
	PLL_RATE(1932000000, 161, 1, 1), /*DCO=3864M*/
	PLL_RATE(1944000000, 162, 1, 1), /*DCO=3888M*/
	PLL_RATE(1956000000, 163, 1, 1), /*DCO=3912M*/
	PLL_RATE(1968000000, 164, 1, 1), /*DCO=3936M*/
	PLL_RATE(1980000000, 165, 1, 1), /*DCO=3960M*/
